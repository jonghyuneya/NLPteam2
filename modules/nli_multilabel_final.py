...
def build_candidate_labels() -> List[str]:
    """
    라벨 후보 목록 생성 - CORE 라벨만 반환
    """
    return LABEL_CORE.copy()
...
def apply_nli_multilabel_for_business(
    ...
    """
    NLI 기반 멀티라벨 분류를 적용하는 메인 함수 (CORE 라벨만 사용)
    """
    ...
    print(f"[Info] Using {len(candidate_labels)} core labels")
